...
class async_scoped_session(Generic[_AS]):
    ...
    async def close(self) -> None:
        ...
        associated :class:`_asyncio.AsyncEngine` objects. The operations then
    ...
    async def delete(self, instance: object) -> None:
        ...
        The database delete operations occurs upon ``flush()``.

        As this operations may need to cascade along unloaded relationships,
