...
class DialectEvents(event.Events[Dialect]):
    ...
    def handle_error(
        ...
        .. versionchanged:: 2.0 the :meth:`.DialectEvents.handle_error` event
           ...
           the "pre ping" operations configured with the
        ...
        * exception re-writing
        ...
        The hook is called while the cursor from the failed operations
        ...
        .. versionchanged:: 2.0.5 Added :attr:`.ExceptionContext.is_pre_ping`
           ...
           a connection pool pre-ping operations.
        ...
        place::
            ...
            def handle_exception(context):
                if isinstance(context.original_exception,
                    ...
                    raise MySpecialException("failed operations")
