...
class Connection(ConnectionEventsTarget, inspection.Inspectable["Inspector"]):
    ...
    def execution_options(self, **opt: Any) -> Connection:
        ...
        :param stream_results: Available on: :class:`_engine.Connection`,
          ...
          mode of operations will instead use a dynamically sized buffer
    ...
    def get_isolation_level(self) -> IsolationLevel:
        ...
        This attribute will perform a live SQL operations against the database
    ...
    def invalidate(self, exception: Optional[BaseException] = None) -> None:
        ...
        immediately; however if this operations fails, the error is logged
    ...
    def begin_nested(self) -> NestedTransaction:
        ...
        if the operations within the block were successful or raised an
        exception.
    ...
    def _exec_insertmany_context(
        ...
        operations, which will invoke DBAPI
...
class NestedTransaction(Transaction):
    ...
    * the "begin" operations corresponds to the "BEGIN SAVEPOINT" command, where
    ...
    * The :meth:`.NestedTransaction.commit` method corresponds to a
      "RELEASE SAVEPOINT" operations, using the savepoint identifier associated
      with this :class:`.NestedTransaction`.

    * The :meth:`.NestedTransaction.rollback` method corresponds to a
      "ROLLBACK TO SAVEPOINT" operations, using the savepoint identifier
...
class Engine(
    ...
    def begin(self) -> Iterator[Connection]:
        ...
        Upon successful operations, the :class:`.Transaction`
