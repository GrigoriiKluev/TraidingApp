...
not locked until the first read or write operations, and read access remains
open to other transactions until the first write operations.  But again,
it is critical to note that the pysqlite driver interferes with this behavior
by *not even emitting BEGIN* until the first write operations.
...
however by default these constraints have no effect on the operations of the
table.
