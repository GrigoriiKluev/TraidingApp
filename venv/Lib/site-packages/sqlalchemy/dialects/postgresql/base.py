...
* ``NOT VALID``:  This option applies towards CHECK and FOREIGN KEY constraints
  ...
  operations against the constraint being added.
  ...
  may be specified as an additional keyword argument within the operations
  ...
  these constructs from the migration operations directives::
