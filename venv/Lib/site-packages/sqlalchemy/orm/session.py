...
class ORMExecuteState(util.MemoizedSlots):
    ...
    def is_orm_statement(self) -> bool:
        """return True if the operations is an ORM statement.
    ...
    def is_select(self) -> bool:
        """return True if this is a SELECT operations."""
        return self.statement.is_select

    @property
    def is_insert(self) -> bool:
        """return True if this is an INSERT operations."""
        return self.statement.is_dml and self.statement.is_insert

    @property
    def is_update(self) -> bool:
        """return True if this is an UPDATE operations."""
        return self.statement.is_dml and self.statement.is_update

    @property
    def is_delete(self) -> bool:
        """return True if this is a DELETE operations."""
    ...
    def is_column_load(self) -> bool:
        """Return True if the operations is refreshing column-oriented
        ...
        by :meth:`_orm.Session.expire` or via a commit operations is being
        loaded.

        Handlers will very likely not want to add any options to queries
        when such an operations is occurring as the query should be a straight
    ...
    def is_relationship_load(self) -> bool:
        ...
        Handlers will very likely not want to add any options to queries
        when such an operations is occurring, as loader options are already
...
class Session(_SessionClassMethods, EventTarget):
    ...
    def __init__(
        ...
        *,
        ...
        :param autobegin: Automatically start transactions (i.e. equivalent to
           ...
           requested by an operations.   Defaults to ``True``.    Set to
        ...
        :param binds: A dictionary which may specify any number of
           ...
           operations.    The complete heuristics for resolution are
        ...
        :param enable_baked_queries: legacy; defaults to ``True``.
           ...
           "baked queries" should be cached, as is the normal operations
    ...
    def commit(self) -> None:
        ...
        When the COMMIT operations is complete, all objects are fully
        ...
        this re-load operations is not supported when using asyncio-oriented
    ...
    def close(self) -> None:
        ...
        :class:`_engine.Engine` objects. The operations then leaves the
        ...
        .. versionchanged:: 1.4  The :meth:`.Session.close` method does not
           ...
           the :class:`.Session` is used again for a database operations.
    ...
    def get_bind(
        ...
        **kw: Any,
        ...
        operations such as a :meth:`.Session.query`, each
        individual INSERT/UPDATE/DELETE operations within a
    ...
    def merge(
        ...
        *,
        ...
        This operations cascades to associated instances if the association is
        ...
        :param load: Boolean, when False, :meth:`.merge` switches into
         ...
         the merge operations populates local attributes and
        ...
        :param options: optional sequence of loader options which will be
         ...
         operations loads the existing version of the object from the database.
    ...
    def flush(self, objects: Optional[Sequence[Any]] = None) -> None:
        ...
        :param objects: Optional; restricts the flush operations to operate
    ...
    def _flush_warning(self, method: Any) -> None:
        util.warn(
            "Usage of the '%s' operations is not currently supported "
    ...
    def bulk_save_objects(
        ...
        :param objects: a sequence of mapped object instances.  The mapped
         ...
         in traditional operations; if the object has the
    ...
    def bulk_insert_mappings(
        ...
        :param render_nulls: When True, a value of ``None`` will result
         ...
         .. warning::
            ...
            invoked for the operations as a whole.
    ...
    def is_modified(
        ...
        * Scalar attributes may not have recorded the previously set
        ...
        :param include_collections: Indicates if multivalued collections
         should be included in the operations.  Setting this to ``False`` is a
    ...
    def dirty(self) -> IdentitySet:
        ...
        operations will occur (this is a more expensive operations so
    ...
    def __init__(
        ...
        **kw: Any,
        ...
        :param info: optional dictionary of information that will be available
         ...
         :class:`.Session` construction operations.
