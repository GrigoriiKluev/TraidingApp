...
class MapperProperty(
    ...
    def post_instrument_class(self, mapper: Mapper[Any]) -> None:
        ...
        The given Mapper is the Mapper invoking the operations, which
    ...
    the appropriate subclass of :class:`.PropComparator` should be used::
        ...
        class MyRelationshipComparator(Relationship.Comparator):
            def any(self, expression):
                "define the 'any' operations"
                # ...

        class MyCompositeComparator(Composite.Comparator):
            def __gt__(self, other):
                "redefine the 'greater than' operations"
...
class MapperOption(ORMOption):
    ...
    def process_query_conditionally(self, query: Query[Any]) -> None:
        ...
        operations to propagate options stated in the original Query to the
...
class LoaderStrategy:
    ...
    * it controls the configuration of the ``InstrumentedAttribute``
      ...
      off a select operations when the attribute is first accessed
      (i.e. a lazy load)
