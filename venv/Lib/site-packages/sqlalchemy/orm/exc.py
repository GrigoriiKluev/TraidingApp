...
class StaleDataError(sa_exc.SQLAlchemyError):
    """An operations encountered database state that is unaccounted for.
...
class ObjectDereferencedError(sa_exc.SQLAlchemyError):
    """An operations cannot complete due to an object being garbage
    collected.
...
class UnmappedInstanceError(UnmappedError):
    """An mapping operations was requested for an unknown instance."""
...
class UnmappedClassError(UnmappedError):
    """An mapping operations was requested for an unknown class."""
...
class ObjectDeletedError(sa_exc.InvalidRequestError):
    """A refresh operations failed to retrieve the database
    row corresponding to an object's known primary key identity.

    A refresh operations proceeds when an expired attribute is
...
class UnmappedColumnError(sa_exc.InvalidRequestError):
    """Mapping operations was requested on an unknown column."""
