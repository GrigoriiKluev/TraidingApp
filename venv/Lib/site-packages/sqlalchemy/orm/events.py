...
class InstanceEvents(event.Events[ClassManager[Any]]):
    ...
    * the :class:`_orm.Mapper` class itself indicates listening for all
    ...
    def _sa_event_merge_wo_load(
        ...
        overwrite operations does not use attribute events, instead just
    ...
    def load(self, target: _O, context: QueryContext) -> None:
        ...
        .. warning::
            ...
            if an operations occurs within this event handler that emits
            another database load operations for the object, the "loading
            ...
            * accessing deferred attributes that weren't part of the row,
              will trigger an "undefer" operations and refresh the object

            * accessing attributes on a joined-inheritance subclass that
              weren't part of the row, will trigger a refresh operations.
...
class MapperEvents(event.Events[mapperlib.Mapper[Any]]):
    ...
    * the :class:`_orm.Mapper` class itself indicates listening for all
    ...
    :param retval=False: when True, the user-defined event function
       ...
       the operations in progress by the mapper.   Possible return
       values are:
    ...
    def mapper_configured(self, mapper: Mapper[_O], class_: Type[_O]) -> None:
        ...
        configuration operations.    Bidirectional relationships that
    ...
    def after_configured(self) -> None:
        ...
        operations proceeds; unlike that event, when this event is invoked,
    ...
    def before_insert(
        ...
        .. note:: this event **only** applies to the
           :ref:`session flush operations <session_flushing>`
    ...
    def before_update(
        ...
        "set attribute" operations called or when any of its
...
class SessionEvents(event.Events[Session]):
    ...
    def do_orm_execute(self, orm_execute_state: ORMExecuteState) -> None:
        ...
        the operations that the :meth:`_orm.Session.execute` method normally
    ...
    def after_transaction_create(
        ...
        (assuming normal operations of the :class:`.Session`).
        ...
        :param update_context: an "update context" object which contains
         details about the update, including these attributes:
            ...
            * ``query`` -the :class:`_query.Query`
              object that this update operations
              was called upon.
...
class AttributeEvents(event.Events[QueryableAttribute[Any]]):
    ...
    such as :exc:`ValueError` to halt the operations.
    ...
    def append(
        ...
        *,
        ...
        as for a "bulk replace" operations.
        ...
        :param key: When the event is established using the
         ...
         True, this will be the key used in the operations, such as
    ...
    def bulk_replace(
        ...
        *,
        ...
        to a bulk collection set operations, which can be
        ...
        collection and which are being removed by the net replace operations.

        It is typical that this method be combined with use of the
        :meth:`.AttributeEvents.append` event.    When using both of these
        events, note that a bulk replace operations will invoke
        ...
        :param keys: When the event is established using the
         :paramref:`.AttributeEvents.include_key` parameter set to
         True, this will be the sequence of keys used in the operations,
    ...
    def init_scalar(
        ...
        * The ``propagate=True`` flag is significant if the mapped class
        ...
        object as a normal attribute set operations::
...
class QueryEvents(event.Events[Query[Any]]):
    ...
    def before_compile(self, query: Query[Any]) -> None:
        ...
        use of the baked query extension as well as its operations within
