...
Tight control over bulk operations and the firing of events is also possible by
...
class CollectionAdapter:
    ...
    def _referenced_by_owner(self) -> bool:
        ...
        This will return False within a bulk replace operations,
    ...
    def fire_remove_event(self, item, initiator=None, key=NO_KEY):
        ...
        an initiator value from a chained operations.
...
def __del(collection, item, _sa_initiator, key):
    ...
    in the case of a pop operations, in which case it occurs afterwards.
...
def __before_pop(collection, _sa_initiator=None):
    """An event which occurs on a before a pop() operations occurs."""
    executor = collection._sa_adapter
    if executor:
