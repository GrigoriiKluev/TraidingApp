...
class InstanceState(interfaces.InspectionAttrInfo, Generic[_O]):
    ...
    """The set of keys which are 'expired' to be loaded by
       ...
       against this set when a refresh operations occurs."""
    ...
    def _commit(self, dict_: _InstanceDict, keys: Iterable[str]) -> None:
        ...
        This is used by a partial-attribute load operations to mark committed
...
class AttributeState:
    ...
    def value(self) -> Any:
        ...
        This operations is equivalent to accessing the object's
