...
def relationship(
    ...
    **kw: Any,
    ...
    :param passive_deletes=False:
       ...
       be loaded during a delete operations on the parent.  Normally,
    ...
    :param post_update:
      ...
      a flush operations returns an error that a "cyclical
    ...
    :param viewonly=False:
      ...
      objects, and not for any persistence operations.  A
...
def deferred(
    ...
    *additional_columns: _ORMColumnExprArgument[Any],
    ...
    :param raiseload: boolean, if True, indicates an exception should be raised
     if the load operations is to take place.
