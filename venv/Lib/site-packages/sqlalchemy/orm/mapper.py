...
class Mapper(
    ...
    def __init__(
        ...
        :param passive_updates: Indicates UPDATE behavior of foreign key
           ...
           operations for an update.  The unit of work process will
    ...
    will be written on a persist operations.
...
def configure_mappers():
    ...
    * :meth:`.MapperEvents.before_configured` - called once before
      ...
      related mappings before the operations proceeds.
    ...
    * :meth:`.MapperEvents.after_configured` - called once after
      ...
      within the scope of the configuration operations will be fully configured.
...
def reconstructor(fn):
    ...
    this stage will not be recorded for the next flush() operations, so
