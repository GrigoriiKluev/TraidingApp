    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        :param load_on_unexpire:
          ...
          operations, i.e. the "expired_attribute_loader" process.
...
class CollectionAttributeImpl(HasCollectionAdapter, AttributeImpl):
    ...
    def fire_pre_remove_event(
        ...
        the item before the operations.   the event is used for all pop()
        ...
        if (
            ...
            if (
                ...
                if not check_for_dupes_on_remove or not util.has_dupes(
                    ...
                    # present in the list, except for a pop() operations.
    ...
    def from_scalar_attribute(
        ...
        # don't let ClauseElement expressions here trip things up
            ...
            if id(original) in _NO_STATE_SYMBOLS:
                deleted = ()
                # indicate a "del" operations occurred when we don't have
...
def flag_dirty(instance: object) -> None:
    ...
    This is a special operations that will allow the object to travel through
