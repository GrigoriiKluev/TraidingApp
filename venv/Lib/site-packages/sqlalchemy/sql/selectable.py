...
class Selectable(ReturnsRows):
    ...
    def corresponding_column(
        ...
        .. seealso::
            ...
            :class:`_expression.ColumnCollection`
            that is used for the operations.
...
class CompoundSelect(HasCompileState, GenerativeSelect, ExecutableReturnsRows):
    ...
    def _generate_fromclause_column_proxies(
        ...
        *,
        ...
        # that the corresponding_column() operations can resolve
        # conflicts
    ...
    def selected_columns(
        ...
        statements within the set operations.
...
class Select(
    ...
    def from_statement(
        ...
        This operations is :term:`plugin-specific` and will raise a not
    ...
    def with_only_columns(
        ...
        **__kw: Any,
        ...
        In this mode of operations, :meth:`_sql.Select.with_only_columns`
        ...
        collection and performs an operations equivalent to the following::
