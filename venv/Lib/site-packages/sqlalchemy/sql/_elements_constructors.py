...
def and_(  # type: ignore[empty-body]
    ...
    *clauses: _ColumnExpressionArgument[bool],
    ...
    The :func:`.and_` operations is also implicit in some cases;
...
def asc(
    ...
    :param column: A :class:`_expression.ColumnElement` (e.g.
     ...
     with which to apply the :func:`.asc` operations.
...
def bindparam(
    ...
    a comparison operations such as::
    ...
    :param key:
      ...
      value may be modified when part of a compilation operations,
...
def desc(
    ...
    :param column: A :class:`_expression.ColumnElement` (e.g.
     scalar SQL expression)
     with which to apply the :func:`.desc` operations.
...
def false() -> False_:
    ...
    "short circuit" operations within an :func:`.and_` or :func:`.or_`
    conjunction:
