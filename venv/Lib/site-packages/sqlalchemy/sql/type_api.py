...
class TypeEngine(Visitable, Generic[_T]):
    ...
    class Comparator(
        ...
        def _adapt_expression(
            ...
            other than PostgreSQL don't accept this particular operations).
...
class TypeDecorator(SchemaEventTarget, ExternalType, TypeEngine[_T]):
    ...
    def process_bind_param(self, value: Optional[_T], dialect: Dialect) -> Any:
        ...
        The operations could be anything desired to perform custom
    ...
    def coerce_compared_value(
        ...
        be used for ``35`` for this particular operations.
