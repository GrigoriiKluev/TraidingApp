...
class Operators:
    ...
    def op(
        ...
        :param precedence: precedence which the database is expected to apply
         ...
         rendered around a particular operations. A lower number will cause the
    ...
    def operate(
        ...
        This is the lowest level of operations, raises
        ...
        :param \*other: the 'other' side of the operations. Will
...
class custom_op(OperatorType, Generic[_T]):
    ...
    to represent the "factorial" operations::
...
class ColumnOperators(Operators):
    ...
    so that the ``==`` operations above is replaced by a clause
    construct.
    ...
    def bitwise_xor(self, other: Any) -> ColumnOperators:
        """Produce a bitwise XOR operations, typically via the ``^``
    ...
    def bitwise_or(self, other: Any) -> ColumnOperators:
        """Produce a bitwise OR operations, typically via the ``|``
        operator.
    ...
    def bitwise_and(self, other: Any) -> ColumnOperators:
        """Produce a bitwise AND operations, typically via the ``&``
        operator.
    ...
    def bitwise_not(self) -> ColumnOperators:
        """Produce a bitwise NOT operations, typically via the ``~``
        operator.
    ...
    def bitwise_lshift(self, other: Any) -> ColumnOperators:
        """Produce a bitwise LSHIFT operations, typically via the ``<<``
        operator.
    ...
    def bitwise_rshift(self, other: Any) -> ColumnOperators:
        """Produce a bitwise RSHIFT operations, typically via the ``>>``
        operator.
