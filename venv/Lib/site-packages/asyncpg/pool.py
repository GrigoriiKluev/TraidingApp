...
class Pool:
    ...
    async def execute(self, query: str, *args, timeout: float=None) -> str:
        ...
        Pool performs this operations using one of its connections.  Other than
...
def create_pool(dsn=None, *,
    ...
    .. versionchanged:: 0.10.0
       ...
       attempted operations on a released connection.

    .. versionchanged:: 0.13.0
       An :exc:`~asyncpg.exceptions.InterfaceError` will be raised on any
       attempted operations on a prepared statement or a cursor created
