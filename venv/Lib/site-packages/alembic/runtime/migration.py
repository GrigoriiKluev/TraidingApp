...
class MigrationContext:
    ...
    def autocommit_block(self) -> Iterator[None]:
        ...
        DDL or system operations that specifically has to be run outside of
        any kind of transaction block.   The PostgreSQL database platform
        is the most common target for this style of operations, as many
        ...
        .. warning::
            ...
            preceding the operations will be committed, before the overall
            migration operations is complete.
    ...
    def begin_transaction(
        ...
        :meth:`.MigrationContext.run_migrations` operations.

        A "Logical" transaction means that the operations may or may not
        ...
        operations would instead correspond to a string such as "BEGIN" being
    ...
    def run_migrations(self, **kw: Any) -> None:
        ...
        in the case that a command wants to run some other operations
...
class MigrationInfo:
    ...
    is_upgrade: bool
    """True/False: indicates whether this operations ascends or descends the
    version tree."""

    is_stamp: bool
    """True/False: indicates whether this operations is a stamp (i.e. whether
    ...
    In the case of a stamp operations, it is advised to use the
    :attr:`.MigrationInfo.up_revision_ids` tuple as a stamp operations can
    ...
    ``alembic stamp`` operations which is moving downwards from multiple
    ...
    """The revision map inside of which this operations occurs."""
    ...
    def is_migration(self) -> bool:
        """True/False: indicates whether this operations is a migration.

        At present this is true if and only the migration is not a stamp.
        If other operations types are added in the future, both this attribute
