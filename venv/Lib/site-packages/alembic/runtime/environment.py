...
class EnvironmentContext(util.ModuleClsProxy):
    ...
    def configure(
        ...
        **kw: Any,
        ...
        :param on_version_apply: a callable or collection of callables to be
            ...
            each migration step, after the respective operations has been
        ...
        :param compare_type: Indicates type comparison behavior during
         an autogenerate
         operations.  Defaults to ``False`` which disables type
         comparison.  Set to
        ...
        :param compare_server_default: Indicates server default comparison
         behavior during
         an autogenerate operations.  Defaults to ``False`` which disables
         server default
         ...
         defaults during an autogenerate operations.   The format of this
         callable is::
        ...
        :param process_revision_directives: a callable function that will
         ...
         or plain "revision" operations, which can be manipulated to affect
    ...
    def begin_transaction(
        ...
        enclose an operations within a "transaction",
