...
class AbstractOperations(util.ModuleClsProxy):
    ...
    def register_operation(
        ...
        """Register a new operations for this class.
    ...
    def implementation_for(cls, op_cls: Any) -> Callable[..., Any]:
        ...
        This is part of the operations extensibility API.
    ...
    def batch_alter_table(
        ...
        operations on other backends will proceed using standard ALTER TABLE
        operations.
        ...
        The copy operations by default uses reflection to retrieve the current
        ...
        .. note::  The table copy operations will currently not copy
...
class Operations(AbstractOperations):
    ...
    Each operations corresponds to some schema migration operations,
...
class BatchOperations(AbstractOperations):
    ...
    def _noop(self, operation):
        raise NotImplementedError(
            "The %s method does not apply to a batch table alter operations."
            % operation
        )
