...
class AutogenContext:
    ...
    def run_name_filters(
        ...
        should be part of the autogenerate operations.

        This method should be run for every kind of name encountered within the
        reflection side of an autogenerate operations, giving the environment
    ...
    def run_object_filters(
        ...
        an autogenerate operations, giving the environment the chance
